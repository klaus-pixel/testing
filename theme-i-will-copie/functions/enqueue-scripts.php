...
function site_scripts() {
  global $wp_styles; // Call global $wp_styles variable to add conditional wrapper around ie stylesheet the WordPress way
    ...
    wp_enqueue_style( 'site-style.css', get_template_directory_uri() . '/style.css', array(), filemtime(get_template_directory() . '/'), 'all' );

    wp_enqueue_style( 'hamburgers.css', get_template_directory_uri() . '/assets/styles/hamburgers.css', array(), filemtime(get_template_directory() . '/assets/styles'), 'all' );
