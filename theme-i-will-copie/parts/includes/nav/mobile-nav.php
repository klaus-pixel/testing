...
<nav id="mobile-nav">
    <nav id="mobile-nav-section" class="slideInUp collapsed-hamburger"  style="background: scroll #b71234; height: 101%; position: fixed; width: 100%; z-index: 0; margin-top: -15px; margin-left:-15px;overflow: scroll;">
            ...
            <div class="mobile-nav-content">
                <div class="grid-x">
                    ...
                    <div class="column medium-4 small-4 text-right">
                        <button id="active-hamburger" class="hamburger hamburger--collapse margin-for-red-heading is-active" type="button" style="margin-top: 13px !important;">
...
//                if($item->menu_item_parent == 0 && $item->type_label != 'Language switcher'){
                        ...
                        <div class="row">
                            <div class="columns text-center">
                                <ul class="accordion primary-accordion" data-accordion data-allow-all-closed="true">
                                    <li class="accordion-item" data-accordion-item>
                                        <a onclick="return false;" href="<?php echo $item->url; ?>" style="color: #fff !important;" class="accordion-title <?php if(!$navigation->hasChildren($item->ID)){echo 'remove-chevron-from-accordion';}else{echo '';} ?>" ><?php pll_e($item->title); ?></a>
                                        <?php foreach ($navigation->hasChildren($item->ID) as $child) {
                                            if($child){
                                                ?>
                                                <div class="accordion-content" data-tab-content >
    ...
    <div class="grid-x">
        ...
        <div class="column medium-4 small-4 text-right">
            <button id="hamburger" class="hamburger hamburger--collapse margin-for-red-heading" type="button">
                <span class="hamburger-box">
                    <span class="hamburger-inner"></span>
                </span>
            </button>
