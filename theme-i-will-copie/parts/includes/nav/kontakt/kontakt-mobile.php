<?php get_template_part('parts/includes/contact/before', 'content'); ?>

<nav id="mobile-nav">
    <nav id="mobile-nav-section" class="slideInUp collapsed-hamburger"  style="background: scroll #b71234; height: 101%; position: fixed; width: 100%;top:17px; z-index: 0; margin-top: -25px; margin-left:-15px;overflow: scroll;">
        <div class="fadeInUp delayed">
            <div class="mobile-nav-content">
                <div class="grid-x">
                    ...
                    <div class="column medium-4 small-4 text-right">
                        <button id="active-hamburger" class="hamburger hamburger--collapse is-active contact-hamburger" type="button">
            ...
            <div class="accordion-row">
                <div class="columns text-center">
                    ...
                    <div class="dropdown-pane group-section-dropdown" id="mobile-group-dropdown" data-dropdown data-auto-focus="true">
    ...
    <div class="grid-x">
        <div class="column medium-4 small-4"></div>
        <div class="column medium-4 small-4 text-center">
            <a href="<?php echo home_url(); ?>"><img class="mobile-logo" src="<?php echo home_url('wp-content/themes/solix/assets/images/logo/solix-logo-white.svg') ?>"></a>
        </div>
        <div class="column medium-4 small-4 text-right">
