            ...
            <div class="mobile-nav-content">
                <div class="grid-x">
                    ...
                    <div class="column medium-4 small-4 text-right">
                        <button id="active-hamburger" class="hamburger hamburger--collapse margin-for-red-heading is-active" type="button" style="margin-top: -3px !important;">
